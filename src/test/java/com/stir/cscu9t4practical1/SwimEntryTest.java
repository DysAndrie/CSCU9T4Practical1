...
public class SwimEntryTest {
    ...
    public void testGetWhere() {
        ...
        //Specify the newly made SwimEntry Class to access the method from. 
        SwimEntry instanceA = new SwimEntry("Alice", 1, 2, 2003, 0, 16, 7, 3,"outdoors");
        String expResultA = "outdoors";
        String resultA = instanceA.getWhere(); //Slightly edited result to resultA to differentiate from resultB 
